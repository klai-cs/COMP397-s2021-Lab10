...
public class ControlPanelController : MonoBehaviour
{
    ...
    {
        // Serializing and saving our data to Player Preference dictionary / db -- what we would like to do
    ...
    public void LoadToPlayerPrefs()
    {
        //Deserializing and loading Data from Player Preferences - What we would like to do
